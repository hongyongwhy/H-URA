...
def generate(list_tuple_words_attentions, latex_file, color='red', rescale_value = True):
	string_begin_doc = r'''\documentclass[varwidth]{standalone}
									...
									\begin{document}''' + '\n'
	string_begin_str = r''' \begin{CJK*}{UTF8}{gbsn} ''' + '\n'
	string_end_str = r'''\end{CJK*}''' + '\n'
	string_end_doc = r'''\end{document}''' + '\n'

	with open(latex_file, 'w') as f:
		f.write(string_begin_doc)
		string = r'''{\setlength{\fboxsep}{0pt}\colorbox{white!0}{\parbox{0.9\textwidth}{''' + "\n"
		f.write(string_begin_str)
		for (text_list, attention_list) in list_tuple_words_attentions:
			if rescale_value:
		...
		string += "\n}}}"
		f.write(string)
		f.write(string_end_str)
		f.write(string_end_doc)
